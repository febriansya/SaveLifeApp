 ...
 * Use the [ViewPagerKegiatanFragment.newInstance] factory method to
...
class ViewPagerKegiatanFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ViewPagerKegiatanFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ViewPagerKegiatanFragment().apply {
