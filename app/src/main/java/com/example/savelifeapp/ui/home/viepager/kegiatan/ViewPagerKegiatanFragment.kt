...
@AndroidEntryPoint
class ViewPagerKegiatanFragment : Fragment(),DetailKegiatanListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        kegiatanAdapater = KegiatanAdapater(list,this)
    ...
    override fun itemClicked(kegiatan: Kegiatan) {
        val intent = Intent(requireContext(),DetailKegiatanActivity::class.java)
        intent.putExtra("data_kegiatan",kegiatan)
